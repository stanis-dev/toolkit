...
These are user global preferences and must be applied to every single session. This document contains only **critical**
rules and designed to indicate the most important and significant insights about how user prefers to work.
