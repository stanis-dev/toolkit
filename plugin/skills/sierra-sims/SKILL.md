...
- Whenever agent phrasing is expected to change, always review how that phrasing materialises in simulation replay. Make sure it fits the context, register, formality level, and any other criteria it needs to obey.
