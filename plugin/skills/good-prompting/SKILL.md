...
- Whatever you are modifying, always think of the full context in mind. Understand how other parts of the prompt interact with it. Additions will affect and be affected by other sections of the prompt. Modifications will have ripple effects throughout the prompt. Deletions may give more force to other sections of the prompt or may deprecate existing content.
